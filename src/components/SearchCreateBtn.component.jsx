...
const SearchCreateBtnComponent = ({placeholder,btnName,url,icon}) => {
  return (
    <div className=" flex justify-between items-center mb-3">
      ...
      <div className="">
        <Link to={url} className="text-white flex items-center gap-1 bg-emerald-500 hover:bg-emerald-700 focus:ring-2 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-emerald-500 dark:hover:bg-emerald-600 dark:focus:ring-emerald-800">
          {btnName}
          {icon}
        </Link>
      </div>
