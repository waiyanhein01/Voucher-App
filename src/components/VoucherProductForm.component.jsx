    ...
    <form onSubmit={handleSubmit(productFormHandle)}>
      <div className=" grid grid-cols-5 gap-3 mb-3">
        ...
        <div className=" col-span-2">
          <div className="mb-2 block">
            <label
              className={`text-sm font-medium ${errors.quantity ? "text-red-500" : "text-gray-900"} dark:text-white`}
              data-testid="flowbite-label"
              htmlFor="quantity"
            >
              Quantity
          ...
          <div className="flex">
            <div className="relative w-full">
              ...
              {...register("quantity", { required: true })}
                className={`block w-full border outline-none disabled:cursor-not-allowed disabled:opacity-50 bg-gray-50 text-gray-900 border-gray-300 ${errors.quantity ? "border-red-500" : "border-gray-300 focus:border-cyan-500 focus:ring-cyan-500"}  dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-cyan-500 dark:focus:ring-cyan-500 p-2.5 text-sm rounded-lg`}
                type="number"
                id="quantity"
              />
              {errors.quantity && <span className=" text-red-500 text-xs">Please fill out this field.</span>}
            </div>
          </div>
        </div>
