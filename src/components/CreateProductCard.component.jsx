        ...
        <form onSubmit={handleSubmit(createFormHandle)} className=" mt-5">
          <div>
            <label
              ...
              className={`block mb-1 text-sm font-medium ${errors.product_name ? "text-red-500": "text-gray-900"} dark:text-white`}
            >
              New Product Name
            </label>
            <input
          ...
          <div className="mt-3">
            <label
              htmlFor="price"
              className={`block mb-1 text-sm font-medium ${errors.price ? "text-red-500": "text-gray-900"} dark:text-white`}
            >
              New Product Price
            </label>
            <input
